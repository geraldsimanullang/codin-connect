        ...
        <div className="flex w-[70%] bg-white shadow-lg rounded-lg p-8">
          ...
          <div className="w-1/2 p-6">
            <div className="text-gray-900">
              <h2 className="text-center text-3xl font-semibold mb-6 text-[#535C91]">Create Account</h2>
              ...
              <p className="text-center mt-6 text-gray-600">
                ...
                <Link href="/login" className="text-[#535C91] hover:underline hover:text-[#3f497d] transition-colors duration-300">
                {" "}Login?
                </Link>
              </p>
            </div>
